...
/*
 * init :: (Object document, Object structure) -> Object structure
 */
const init = compose(bindBehaviour, constructDOM);
...
const replaceTarget = doc => () => {
  ...
  const boundStructure = init(doc, structure);

  targetEl.parentNode.insertBefore(boundStructure.el, targetEl);
